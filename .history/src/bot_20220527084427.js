...
var client = redis.createClient(redisURL.port, redisURL.hostname, {no_ready_check})
...
var retweet = function () {
  var params = {
    q: '#100DaysOfCode, JavaScript',  // REQUIRED
    result_type: 'recent',
    lang: 'en'
  }
...
var favoriteTweet = function () {
  var params = {
    q: '#100DaysOfCode, JavaScript, reactjs nodejs #DEVCommunity',  // REQUIRED
    result_type: 'recent',
    lang: 'en'
  }
  // find the tweet
